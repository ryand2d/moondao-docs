...
> [!NOTE] Hands-on example
 As an example, compare the contents of [Glossary (dynamic)](Glossary%20(dynamic).md) (which depends on Dataview) and [Glossary](Glossary.md) (which is a standalone note). If you view the two in source mode, it'll be more obvious.
